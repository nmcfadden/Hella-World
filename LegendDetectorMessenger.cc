...
LegendDetectorMessenger::LegendDetectorMessenger(LegendDetectorConstruction* Det)
: Detector(Det)
{
...
LegendDetectorMessenger::~LegendDetectorMessenger()
{
  delete UpdateCmd;
	delete OverlapsCmd;
	delete StyleCmd;
...
void LegendDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
