...
//
//
// $Id: LegendMinEkineCuts.cc 69148 2013-04-19 10:35:21Z gcosmo $
//
// 
// --------------------------------------------------------------
...
LegendMinEkineCuts::LegendMinEkineCuts(const G4String& aName)
  : LegendSpecialCuts(aName)
{
    if (verboseLevel>1) {
...
LegendMinEkineCuts::LegendMinEkineCuts(LegendMinEkineCuts&)
  : LegendSpecialCuts()
{}


G4double LegendMinEkineCuts::PostStepGetPhysicalInteractionLength(
