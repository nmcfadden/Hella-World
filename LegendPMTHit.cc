...
// ********************************************************************
//
// $Id: LegendPMTHit.cc 72250 2013-07-12 08:59:26Z gcosmo $
//
/// \file optical/Legend/src/LegendPMTHit.cc
/// \brief Implementation of the LegendPMTHit class
//
//
...
G4ThreadLocal G4Allocator<LegendPMTHit>* LegendPMTHitAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

LegendPMTHit::LegendPMTHit()
...
LegendPMTHit::LegendPMTHit(const LegendPMTHit &right) : G4VHit()
{
...
const LegendPMTHit& LegendPMTHit::operator=(const LegendPMTHit &right){
  fPmtNumber = right.fPmtNumber;
  fPhotons=right.fPhotons;
  fPhysVol=right.fPhysVol;
  fDrawit=right.fDrawit;
...
G4int LegendPMTHit::operator==(const LegendPMTHit &right) const{
  return (fPmtNumber==right.fPmtNumber);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void LegendPMTHit::Draw(){
