...
LegendMaxTimeCuts::LegendMaxTimeCuts(const G4String& aName)
...
LegendMaxTimeCuts::LegendMaxTimeCuts(LegendMaxTimeCuts&)
 : LegendSpecialCuts()
{}

 
G4double LegendMaxTimeCuts::PostStepGetPhysicalInteractionLength(
